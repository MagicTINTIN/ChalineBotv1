...
module.exports = {
    ...
    welcome: async function (member) {
        ...
        if (!confwelcomeserv) {
            ...
            if (confwelcomeserv.welcomemention == "y") {
                if (confwelcomeserv.prewelcomemention == "n" || confwelcomeserv.prewelcomemention == "") {
                    prewelcomemention = "n"
                    welcomemention = "n";
                } else {
            ...
            } else if (confwelcomeserv.welcomemention == "m") {
                welcomemention = "m";
                if (confwelcomeserv.prewelcomemention == "n" || confwelcomeserv.prewelcomemention == "") {
                    prewelcomemention = "";
                } else {
            ...
            if (confwelcomeserv.postwelcomemention == "n") { postwelcomemention = "" } else { postwelcomemention = confwelcomeserv.postwelcomemention; }
            //-------------------------------------------------GENERAL
        ...
        try {
            ...
            if (showwelcomeimage == "y") {
                ...
                if (welcomemention == "m") {
                    client.channels.cache.get(channelidwelcome).send({ content: `${prewelcomemention}${member}${postwelcomemention}`, files: [attachment] });
                }
                if (welcomemention == "y") { client.channels.cache.get(channelidwelcome).send({ content: `${prewelcomemention}${postwelcomemention}`, files: [attachment] }); }
                if (welcomemention == "n") { client.channels.cache.get(channelidwelcome).send({ files: [attachment] }); }
            } else {
    ...
    boost: async function (member) {
        ...
        if (!confboostserv) {
            ...
            if (confboostserv.boostmention == "y") {
                if (confboostserv.preboostmention == "n") {
                    preboostmention = "n"
                    boostmention = "n";
                } else {
            ...
            } else if (confboostserv.boostmention == "m") {
                boostmention = "m";
                if (confboostserv.preboostmention == "n") {
                    preboostmention = "";
                } else {
            ...
            if (confboostserv.postboostmention == "n") { postboostmention = "" } else { postboostmention = confboostserv.postboostmention; }
            //-------------------------------------------------GENERAL
        ...
        try {
            ...
            if (showboostimage == "y") {
                ...
                if (boostmention == "m") { client.channels.cache.get(channelidboost).send({ content: `${preboostmention}${member}${postboostmention}`, files: [attachment] }); }
                if (boostmention == "y") { client.channels.cache.get(channelidboost).send({ content: `${preboostmention}${postboostmention}`, files: [attachment] }); }
                if (boostmention == "n") { client.channels.cache.get(channelidboost).send({ files: [attachment] }); }
            } else {

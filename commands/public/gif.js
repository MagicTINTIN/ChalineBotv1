...
Par exemple, vous pouvez dire \`,bonjour\`.\nUne liste est régulièrement mise à jour sur \`https://discord.gg/jfUqQcP88K\` dans les salons cmd-gif-\n*(ATTENTION : Ce serveur est en lecture seule et est un serveur de logs, nous vous conseillons de le mettre en **muet**)*`)
        }

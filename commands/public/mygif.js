                    ...
                    if (err) {
                        ...
                        setTimeout(function () {
                            if (devlist.includes(message.author.id)) {
                                message.channel.send(`Vous êtes contributeur de gif, vous avez donc accès à tous les gifs de toutes les catégories sur tous les serveurs où Chaline se trouve. Les commandes de gif commencent par ",".\nEn tant que contributeur vous avez accès aux commandes personnalisées de tous les serveurs :

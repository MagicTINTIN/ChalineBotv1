                                    ...
                                    if (!eligibilityread) {
                                        ...
                                        if (eligibilityread.elgibility == 1) {
                                            try {
                                                ...
                                                if (!args[0]) {
                                                    return message.channel.send(`Permet de supprimer une commande de gif du serveur.
                                                ...
                                                if (undeletablecommand.includes(commandname)) {
                                                    ...
                                                    return message.channel.send(`Wow ! Cette commande possède trop de pouvoir je ne peut la supprimer ! :/`);
                                                }
                                                existsgiffile = false;
                                                ...
                                                if (existsgiffile != false) {
                                                    try {
                                                        ...
                                                        setTimeout(function () {
                                                            ...
                                                            message.channel.send(`La commande ,${commandname} bien été supprimée !`);
                                                        }, 1000);
                                                    } catch (err) { return console.error(err); }
                                                }
                                                else {
                                                    return message.channel.send(`Il n'y a pas de commande nommée ,${commandname} sur votre serveur:/`)
                                                }

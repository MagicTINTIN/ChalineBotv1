...
module.exports = {
        ...
        for (const choice of choicesList) {
            ...
            // if we do
                ...
                if (rowNb <= maxRow) {
                    ...
                    return embederror("Fonctionnalité désactivée", "La commande a trop de choix. Merci d'utiliser la commande manuellement en tapant `;" + cmd.name + "`")
                }
    ...
    voicechannelmenu: function () {
        ...
        customidPart = 1
        rowNb = 1
        guildChannels = interaction.guild.channels.cache.filter(ch => ch.type === 'GUILD_VOICE').sort((a, b) => a.rawPosition - b.rawPosition);
        ...
        for (const choicechannelraw of guildChannels) {
            ...
            // if we do
                ...
                row.addComponents(
                    new MessageSelectMenu()
                        .setCustomId('menuVoiceChannelChoice' + customidPart)
                        .setPlaceholder('Choisissez un channel')
                        .addOptions(listChannelSelction),
                );
                if (rowNb <= maxRow) {
                    ...
                    return embederror("Fonctionnalité désactivée", "Ce serveur possède trop de channels vocaux pour moi. Merci d'utiliser la commande manuellement en tapant `;" + cmd.name + "`")
                }
